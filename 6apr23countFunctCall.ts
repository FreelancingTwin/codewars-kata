 ...
 */
 ...
 //when createCounter is called, it returns an int, specifically nested function returns it. it prolly concats into an array outside, so your job is just to return an arr
